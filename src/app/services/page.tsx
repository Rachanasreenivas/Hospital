...
//                   <div className="bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 h-full flex flex-col overflow-hidden border border-gray-100">
...
//                         <Image src="https://placehold.co/300x300/ffffff/6d28d9?text=Doctor" alt="Friendly Doctor" fill className="object-contain" />
//                     </div>
//                 </div>
...
// // Replaces '../component/FooterSection'
// // const Footer = () => (
// //     <footer className="bg-slate-800 text-white py-12">
// //         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
// //             <p>&copy; {new Date().getFullYear()} CurePlus Hospitals. All Rights Reserved.</p>
// //         </div>
// //     </footer>
// // );
